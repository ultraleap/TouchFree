...
export class SVGCursor extends TouchlessCursor {
    ...
    propertyToGet: (inputAction: any) => Array<number>;
    index: number|undefined;

    constructor(index: number|undefined, _propertyToGet = (inputAction: any) => {return inputAction.CursorPosition;}, _xPositionAttribute = "cx", _yPositionAttribute = "cx", _ringSizeMultiplier = 2, _darkCursor = false) {
        super(undefined);
        ...
        svgElement.style.opacity = this.index !== undefined ? '1' : '0';
        ...
        svgElement.id = 'svg-cursor' + (index !== undefined ? '-' + index : '');
        ...
        this.propertyToGet = _propertyToGet;
    ...
    UpdateCursor(_inputAction: any) {
        ...
        const position = this.propertyToGet(_inputAction);
