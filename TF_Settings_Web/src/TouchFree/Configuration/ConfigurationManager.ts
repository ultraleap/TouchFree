...
export class ConfigurationManager {
    ...
    public static SendInputOverride(_input: InputOverride) {
        ...
        ConnectionManager.serviceConnection()?.SendMessage(jsonContent, requestID, ConfigurationManager.InputOverrideResponse);
    }

    public static InputOverrideResponse(detail: WebSocketResponse) {
        console.log(`Got a response from an InputOverride: ${detail}`);
    }
