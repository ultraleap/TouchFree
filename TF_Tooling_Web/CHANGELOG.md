...
- `OpenFolder` function added to ConnectionManager which now allows you to request the service to open a predefined folder (currently can open TouchFree logs folder and Tracking logs folders)
