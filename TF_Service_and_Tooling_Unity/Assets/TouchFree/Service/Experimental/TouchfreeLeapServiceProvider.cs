...
namespace Leap.Unity {
  ...
  /// </summary>
  public class TouchfreeLeapServiceProvider : LeapProvider {
    ...
    protected float cachedFrameTime = 0;
    ...
    protected virtual void Update() {
      ...
      if (_useInterpolation) {
        ...
        // Only update the frame data at the rate defined by the target framerate
        ...
        else if (Time.time - cachedFrameTime > (1.0f / (float)targetFrameRate))
        {
          _leapController.GetInterpolatedFrameFromTime(_untransformedUpdateFrame, timestamp, CalculateInterpolationTime() - (BounceAmount * 1000));
    ...
    {
      targetFrameRate = ConfigManager.InteractionConfig.HandDataUpdateRate;
    }
  }
